...
<link rel="stylesheet" type="text/css" href="../../themes/dist/css/bootstrap.css" >
<link rel="stylesheet" type="text/css" href="../../themes/dist/css/body.css" >
    ...
    <ul class="nav nav-tabs" id="myTab">
      ...
      <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li ><a href="#histories" data-toggle="tab" onclick='top.restoreSession()'>History</a></li>
            <li ><a href="#reports" data-toggle="tab" onclick='top.restoreSession()'>Reports</a></li>
            <li ><a href="#documents" data-toggle="tab" onclick='top.restoreSession()'>Documents</a></li>
            <li ><a href="#transactions" data-toggle="tab" onclick='top.restoreSession()'>Referals</a></li>          
          </ul>
      </li>  
    </ul>
